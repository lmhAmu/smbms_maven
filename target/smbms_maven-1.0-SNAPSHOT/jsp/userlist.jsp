                ...
                <tr class="firstTr">
                   ...
                   <c:forEach var="user" items="${userList }" varStatus="status">
					<tr>
						...
						<td>
						<span><a class="viewUser" href="${pageContext.request.contextPath }/userview.do?userid=${user.id}"><img src="${pageContext.request.contextPath }/images/read.png" alt="查看" title="查看"/></a></span>
