	...
	<table class="providerTable" cellpadding="0" cellspacing="0">
		...
		<c:forEach var="bill" items="${list}" varStatus="status">
			<tr>
				...
				<td>
					<span><a class="viewBill" href="${pageContext.request.contextPath}/billview.do?billid=${bill.id}"><img src="${pageContext.request.contextPath }/images/read.png" alt="查看" title="查看"/></a></span>
					<span><a class="modifyBill" href="${pageContext.request.contextPath}/billmodify.do?billid=${bill.id}"><img src="${pageContext.request.contextPath }/images/xiugai.png" alt="修改" title="修改"/></a></span>
...
<script>
	$(document).ready(function (){
			$(".deleteBill").click(function () {
				...
				$.ajax({
					type: "post",
					url:"${pageContext.request.contextPath}/billdelete.do?id="+billObj.attr("billid"),
					dataType:"text",
					success:function(data){
						if(data!="true"){//删除成功：移除删除行
							alert("对不起，删除失败");
						}else{
							alert("订单【"+billObj.attr("billcc")+"】,删除成功");
